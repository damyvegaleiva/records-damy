...
// TRAER DATA DE ARCHIVO LOCAL JSON (API FICTICIA) / FUNCIÓN AUTO-EJECUTABLE.
...
//POSTEANDO LA COMPRA AL JSON PLACEHOLDER + LIMPIA EL CARRITO POST-COMPRA
...
// TRAER CARRITO DEL STORAGE O EMPEZARLO VACIÓ
let cart = JSON.parse(localStorage.getItem("CART")) || [];

//RENDERIZAR SI HAY ITEMS EN EL CARRITO
renderItemCart();

//FUNCIÓN AUTO-EJECUTABLE PARA CREAR VINILOS
function renderVinylEl(arrayToRender) {
  arrayToRender.forEach((vinyl) => {
    vinylContainer.innerHTML += `
...
// CUANDO SE AGREGUE UN ITEM AL CARRITO POR PRIMERA VEZ SE EJECUTA EL ELSE PUSHEANDO AL CARRITO EL ITEM CON TODAS SUS PROPIEDADES Y AGREGÁNDOLE UNA PROPIEDAD DE UNIDAD.
...
// MUESTRA EN EL CONTADOR EL TOTAL DEL UNIDADES 
function updateCart() {
...
// FUNCIÓN REUTILIZABLE PARA ALMACENAR ITEMS EN EL LOCAL STORAGE
...
// CLICK PARA EJECUTAR LA FUNCIÓN DE MOSTRAR O NO CARRITO.
buttonCart.onclick = showCart;
purchaseButton.onclick = newPurchase;

// BÚSQUEDA EN VIVO DE VINILOS POR SU ARTISTA Y/O ALBUM
